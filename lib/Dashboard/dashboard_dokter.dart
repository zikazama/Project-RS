...
class _DashboardDokterState extends State<DashboardDokter> with WidgetsBindingObserver{
  ...
  void setStatus(String status)async{
    ...
    var data = await _firestore.collection("users").doc(controllerDokter.dokter.value.noKtp).update({
      "status" : status
    });

    print("data : " + await _firestore.collection("users").doc(controllerDokter.dokter.value.noKtp).get().toString());
  }
